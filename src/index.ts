  ...
  return {
    tools: [
      ...
      },
      {
        name: "list_documents",
        description:
          "This tool returns the list of available document files in the docs directory. If you haven't yet retrieved the general information with fetch_general, please run fetch_general first.",
        inputSchema: {
          type: "object",
          properties: {
            category: {
              type: "string",
              description:
                "Search categories: pd-manual, stacker-manual, flex-manual, hepa-uv, shared, thermocycler-manual, dev_setup. If no category is specified, all categories will be targeted",
              enum: [
                "pd-manual",
                "stacker-manual",
                "flex-manual",
      ...
      },
      {
        ...
        description:
          "This tool returns the content of the specified document file. If you haven't yet retrieved the general information with fetch_general, please run fetch_general first.",
        inputSchema: {
          type: "object",
          properties: {
            filename: {
